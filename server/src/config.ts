...
const getTestConfig = (): Config => {
  return {
    ...
    MEDOC_ACTION_URL: 'https://api.medoc.ua/lic/action_new.php',
    MEDOC_ACTION_XOR_KEY: 'test-action-xor-key',
...
const getProductionConfig = (): Config => {
  ...
  return {
    ...
    MEDOC_ACTION_URL: required('MEDOC_ACTION_URL', process.env.MEDOC_ACTION_URL),
    MEDOC_ACTION_XOR_KEY: required('MEDOC_ACTION_XOR_KEY', process.env.MEDOC_ACTION_XOR_KEY),
